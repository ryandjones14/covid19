...
function Stats(_ref) {
  ...
  function statsConf() {
    ...
    return typeof stats === 'array' ? stats.confirmed.value : stats[0].confirmed.value;
  }

  function statsDeath() {
    var stats = Object(_utils_useStats__WEBPACK_IMPORTED_MODULE_1__["default"])(url);
    return typeof stats === 'array' ? stats.deaths.value : stats[0].deaths.value;
  }

  function statsRec() {
    var stats = Object(_utils_useStats__WEBPACK_IMPORTED_MODULE_1__["default"])(url);
    return typeof stats === 'array' ? stats.recovered.value : stats[0].recovered.value;
  }
...
//# sourceMappingURL=index.js.9bc71b50ad272e3fe4fb.hot-update.js.map